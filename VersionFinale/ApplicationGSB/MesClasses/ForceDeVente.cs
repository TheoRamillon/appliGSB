...
namespace MesClasses
{
    public class ForceDeVente
    {
        ...
        public int getAge()
        {
            int dateActuelle =  int.Parse(DateTime.Now.Date.ToString("yyyy"));
            DateTime dateNaiss = DateTime.Parse(this.dateNaissance);
            int dateN = int.Parse(dateNaiss.ToString("yyyy"));
            int age = dateActuelle - dateN;
            return age;
